...
private struct SignalCall: Equatable, Sendable {
    let pid: Int32
    let signal: Int32
}
...
private actor FakeSessionStopper: SimulatorSessionStopping {
...
private struct ControllerMonkeydoLifecycle: MonkeydoProcessLifecycling, Sendable {
    let pathLookup: @Sendable (Int32) -> String?
...
private final class MutableProcessPath: @unchecked Sendable {
    private let lock = NSLock()
    private var storage: String?
