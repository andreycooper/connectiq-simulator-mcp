...
struct Task17InstallContractTests {
    ...
    func bootstrapComposition() throws {
        ...
        #expect(main.contains("version: \"0.4.1\""))
    }

    @Test("v0.4.1 release metadata is consistent across bootstrap and packaging")
    func releaseMetadata() throws {
        ...
        #expect(makefile.contains(
            "/usr/bin/plutil -insert CFBundleShortVersionString -string 0.4.1"))
        #expect(!main.contains("0.4.0"))
    }
